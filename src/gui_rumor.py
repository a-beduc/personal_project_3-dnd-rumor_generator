...
class PageRumor(Page):
    def __init__(self, parent, init_file_path, memory_file_path, *args, **kwargs):
        ...
        self.frame = tk.Frame(self, padx=5, pady=5, bg="#1e1f22")
    ...
    def save_memory(self):
        """Method to write the active memory in the memory_rumor.csv file and allows it to be saved
